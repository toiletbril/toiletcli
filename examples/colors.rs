...
fn main() -> ()
{
  println!("{}{}YOUR TERMINAL {} UNDERLINE STYLING!{}",
  ...
  println!("Byte of (255, 0, 0) is {:?} (should be 196)!",
           Color::RGB(255, 0, 0).byte());
  assert_eq!(Color::RGB(255, 0, 0).byte(), 196);

  println!("{}owo owo owo owo owo owo owo{}",
  ...
  let my_style = StyleBuilder::new().background(Color::BrightGreen)
                                    .add_style(Style::Italic)
                                    .add_style(Style::Strikethrough)
                                    .build();

  println!("{}This is striked and italic text on bright green background!{}",
           my_style,
           Style::Reset);

  let warning = StyleBuilder::new().foreground(Color::BrightBlack)
                                   .background(Color::Red)
                                   .add_style(Style::Bold)
                                   .build();

  let warning_message =
    StyleBuilder::new().foreground(Color::Purple)
  ...
  let weird_style =
    StyleBuilder::new().foreground(Color::Byte(93))
  ...
  let rgb_underline = StyleBuilder::new().foreground(Color::RGB(255, 255, 0))
                                         .add_style(Style::Underlined)
                                         .underline_color(Color::RGB(0, 0, 255))
                                         .build();

  println!("{}Yellow RGB color with very blue RGB underline!{}",
           rgb_underline,
           Style::Reset,);

  let italic = StyleBuilder::new().foreground(Color::BrightBlue)
                                  .add_style(Style::Italic)
                                  .build();

  println!("{}This is blue and italic! And {}THIS{} was not italic!{}",
           italic,
           Style::ResetItalic,
           Style::Italic,
           Style::Reset);

  println!("{}This is also blue and italic! And {}THIS{} was not blue!{}",
           italic,
           Color::Reset,
           Color::BrightBlue,
           Style::Reset);
